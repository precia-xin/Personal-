                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            模拟并发标注和场景，发现并解决接口超时问题，系统在高负载下响应时间稳定在<span className="font-semibold">1s</span>以内，支持<span className="font-semibold">200+</span>并发用户。
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            通过<span className="bg-muted px-1 rounded">AppScan</span>扫描影像上传接口，发现OSS桶权限漏洞及越权访问风险。
                          </p>
                        </div>
                      </div>
                    </div>
